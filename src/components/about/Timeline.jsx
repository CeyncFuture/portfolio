    ...
    <ol class="items-center md:flex">
      <li class="relative mb-6 sm:mb-0">
        <div class="flex items-center justify-evenly">
          <div class="hidden md:flex w-full bg-gray-200 h-0.5 dark:bg-gray-700 mx-2"></div>
          <div class="z-10 flex items-center justify-center w-30 h-30 bg-blue-100 rounded-full  dark:bg-blue-900  shrink-0">
            <svg
